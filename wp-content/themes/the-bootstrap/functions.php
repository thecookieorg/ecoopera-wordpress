...
function the_bootstrap_setup() {
	...
	register_nav_menus( array(
		...
		'aboutus-menu'  	=>	__( 'About US Page', 'the-bootstrap' ),
		'services-menu'  	=>	__( 'Services Page', 'the-bootstrap' ),
		'portfolio-menu'  	=>	__( 'Portfolio Page', 'the-bootstrap' ),
		'projects-menu'  	=>	__( 'Projects Page', 'the-bootstrap' ),
		'header-menu'  	=>	__( 'Header Menu', 'the-bootstrap' ),
		'people-menu'  	=>	__( 'People Page', 'the-bootstrap' ),
...
function the_bootstrap_widgets_init() {
	...
	register_sidebar( array(
		'name'			=>	__( 'Contact Us VANCOUVER', 'the-bootstrap' ),
		'description'	=>	__( 'Contact Us VANCOUVER.', 'the-bootstrap' ),
		'id'			=>	'vancouver',
		'before_widget'	=>	'<aside id="%1$s" class="widget well %2$s">',
		'after_widget'	=>	'</aside>',
		'before_title'	=>	'<h2 class="widget-title">',
	...
	register_sidebar( array(
		'name'			=>	__( 'Contact Us DUBAI', 'the-bootstrap' ),
		'description'	=>	__( 'Contact Us DUBAI.', 'the-bootstrap' ),
		'id'			=>	'dubai',
		'before_widget'	=>	'<aside id="%1$s" class="widget well %2$s">',
		'after_widget'	=>	'</aside>',
		'before_title'	=>	'<h2 class="widget-title">',
	...
	register_sidebar( array(
		'name'			=>	__( 'Contact Us TORONTO', 'the-bootstrap' ),
		'description'	=>	__( 'Contact Us TORONTO.', 'the-bootstrap' ),
		'id'			=>	'toronto',
		'before_widget'	=>	'<aside id="%1$s" class="widget well %2$s">',
		'after_widget'	=>	'</aside>',
		'before_title'	=>	'<h2 class="widget-title">',
	...
	register_sidebar( array(
		'name'			=>	__( 'Contact Us CALGARY', 'the-bootstrap' ),
		'description'	=>	__( 'Contact Us CALGARY.', 'the-bootstrap' ),
		'id'			=>	'calegary',
		'before_widget'	=>	'<aside id="%1$s" class="widget well %2$s">',
		'after_widget'	=>	'</aside>',
		'before_title'	=>	'<h2 class="widget-title">',
	...
	register_sidebar( array(
		'name'			=>	__( 'Contact Us Footer Menu', 'the-bootstrap' ),
		'description'	=>	__( 'Contact Us Footer Menu.', 'the-bootstrap' ),
		'id'			=>	'confootermenu',
		'before_widget'	=>	'<aside id="%1$s" class="widget well %2$s">',
		'after_widget'	=>	'</aside>',
		'before_title'	=>	'<h2 class="widget-title">',
